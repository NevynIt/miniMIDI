...
const fp_int midi_frequencies[128] = {
    ...
    (fp_int)(   13.7500000000 * FP1),  // MIDI Note 9,
    ...
    (fp_int)(   27.5000000000 * FP1),  // MIDI Note 21,
    ...
    (fp_int)(   55.0000000000 * FP1),  // MIDI Note 33,
    ...
    (fp_int)(  110.0000000000 * FP1),  // MIDI Note 45,
    ...
    (fp_int)(  220.0000000000 * FP1),  // MIDI Note 57,
    ...
    (fp_int)(  440.0000000000 * FP1),  // MIDI Note 69,
    ...
    (fp_int)(  880.0000000000 * FP1),  // MIDI Note 81,
    ...
    (fp_int)( 1760.0000000000 * FP1),  // MIDI Note 93,
    ...
    (fp_int)( 3520.0000000000 * FP1),  // MIDI Note 105,
    ...
    (fp_int)( 7040.0000000000 * FP1),  // MIDI Note 117,
