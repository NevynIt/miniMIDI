...
#include "hardware/flash.h"
    ...
    #define FL_COMP_PAGES 16
    #define FL_DECOMP_PAGES 2
    ...
    #define FL_COMP_PAGES (16*4)
    #define FL_DECOMP_PAGES (2*4)
...
#define FL_TOTAL_PAGES (FL_CODE_PAGES + FL_CONFIG_PAGES + FL_RULESET_PAGES + FL_COMP_PAGES + FL_DECOMP_PAGES + FL_LIST_PAGES + FL_ENVELOPE_PAGES + FL_SAMPLE_PAGES)
...
#define FL_COMP_MAX    (FL_COMP_PAGES    * FLASH_PAGE_SIZE / sizeof(comp_t))
#define FL_DECOMP_MAX  (FL_DECOMP_PAGES  * FLASH_PAGE_SIZE / sizeof(decomp_t))
...
typedef struct {
    ...
    comp_t comp[FL_COMP_MAX];
    decomp_t decomp[FL_DECOMP_MAX];
